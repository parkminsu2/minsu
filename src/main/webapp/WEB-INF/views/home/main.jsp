		...
		$.ajax({
			...
			success : function (attendance) {
				...
				if(attendance.movertimeTime != null || attendance.movertimeTime == "") {
						...
						glSumTime = attendance.movertimeTime;
						if(movertimeTime.split(":")[0] < 10){
							console.log("0" + attendance.movertimeTime.split(":")[0])
							console.log(attendance.movertimeTime.split(":")[1])
							console.log(attendance.movertimeTime.split(":")[2])
							movertimeTime = attendance.movertimeTime.split(":")[0] + ":" +  attendance.movertimeTime.split(":")[1] + ":" + attendance.movertimeTime.split(":")[2]
