		...
		$.ajax({
			...
			success : function (attendance) {
				...
				if(attendance.movertimeTime != null || attendance.movertimeTime == "") {
						...
						if (attendance.movertimeTime != "00:00:00" && day == "월"){
							attendance.movertimeTime = "00:00:00";
						}
						$(".glSumTime").html(attendance.movertimeTime);
						console.log(attendance.movertimeTime)
